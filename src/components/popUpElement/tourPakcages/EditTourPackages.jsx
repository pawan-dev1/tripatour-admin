...
import { useAddTourPackagesMutation, useEditTourPackagesMutation } from "../../../store/services/tourPackages";


const EditTourPackages = ({ handleCancel,data,getCategory }) => {
  const {Option} = Select
  const [trigger, { data: craetedTeam }] = useEditTourPackagesMutation();
  ...
  const onFinish = (values) => {
    ...
    trigger({data:formData,id:data?._id});
  };
